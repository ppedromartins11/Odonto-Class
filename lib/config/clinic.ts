/**
 * Nome de exibicao da clinica.
 *
 * PONTO A VALIDAR: nenhuma fonte (requisitos, especificacao, prototipo)
 * informou o nome real da clinica - o prototipo usava "DentClinic"
 * ficticio. Em vez de inventar um nome proprio, uso um rotulo generico
