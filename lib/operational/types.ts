...
export type OperationalTask = { id: string; titulo: string; descricao: string | null; status: TaskStatus; prioridade: TaskPriority; prazo: string | null; responsavel_id: string; paciente_id: string | null; agendamento_id: string | null; created_by: string; created_at: string; ordem_kanban: number; responsavel_nome: string; paciente_nome: string | null };
