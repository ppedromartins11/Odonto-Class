...
export type OperationalTask = { id: string; titulo: string; descricao: string | null; status: TaskStatus; prazo: string | null; responsavel_id: string; paciente_id: string | null; agendamento_id: string | null; created_by: string; created_at: string; responsavel_nome: string; paciente_nome: string | null };
