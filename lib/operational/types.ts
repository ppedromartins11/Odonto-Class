...
export type OperationalReturn = { id: string; paciente_id: string; atendimento_origem_id: string | null; profissional_id: string | null; data_prevista: string; status: ReturnStatus; observacao_administrativa: string | null; agendamento_id: string | null; created_at: string };
